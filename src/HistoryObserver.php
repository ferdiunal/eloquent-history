...
class HistoryObserver
{
    ...
    */
    public function created($model)
    {
        ...
        $model->morphMany(config('history.model'), 'model')->create([
            'message' => trans('ferdiunal::history.created', ['model' => static::getModelName($model), 'label' => $model->getModelLabel()]),
    ...
    */
    public function updating($model)
    {
        ...
        */
        ...
        $model->morphMany(config('history.model'), 'model')->create([
            'message' => trans('ferdiunal::history.updating', ['model' => static::getModelName($model), 'label' => $model->getModelLabel()]),
    ...
    */
    public function deleting($model)
    {
        ...
        $model->morphMany(config('history.model'), 'model')->create([
            'message' => trans('ferdiunal::history.deleting', ['model' => static::getModelName($model), 'label' => $model->getModelLabel()]),
    ...
    */
    public function restored($model)
    {
        ...
        $model->morphMany(config('history.model'), 'model')->create([
            'message' => trans('ferdiunal::history.restored', ['model' => static::getModelName($model), 'label' => $model->getModelLabel()]),
    ...
    public static function getModelName($model)
    {
        ...
        $key = 'ferdiunal::history.models.'.Str::snake($class);
        $value =  trans($key);
    ...
    {
        $type = static::getAuth()->check() ? get_class(static::getAuth()->user()) : null;

        return array_flip(Relation::$morphMap)[ $type ] ?? $type;
    }
